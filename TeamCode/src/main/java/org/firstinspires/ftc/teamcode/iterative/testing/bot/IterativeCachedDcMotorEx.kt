 ...
 */
class IterativeCachedDcMotorEx(private val delegate: DcMotorEx, private val HUB: IterativeRevHub) : DcMotorEx {
    val PORT = delegate.portNumber
    private val MOTOR_TYPE = delegate.motorType
    val TICKS_PER_REV = MOTOR_TYPE.ticksPerRev
    // todo investigate this
    val encoder = IterativeEncoder(HUB, delegate.portNumber, TICKS_PER_REV.toInt(), delegate.direction)
